...
description: 项目文档与工作流管理。初创项目时创建文档骨架、AGENTS.md；开发项目额外配置工具链。过程中按规则更新文档。触发场景：初始化项目、创建/更新文档、整理项目规范、配置开发环境。
---
...
- 根目录放核心文档（prd, cautions, techstack 等）
